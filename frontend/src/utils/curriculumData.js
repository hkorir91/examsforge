...
export const CBC_CURRICULUM = {
  'Grade 10': {
    subjects: [
      ...
      'Physical Education',
      // Community Service Learning (KICD Official)
  'Citizenship': ['Community Needs', 'Leadership Development', 'Intercultural Competence'],
  'Life Skills': ['Self Awareness', 'Conflict Resolution', 'Responsible Decision Making'],
  'Action Research': ['Introduction to Action Research', 'Problem Identification'],

  // Computer Studies (KICD Official Grade 10)
  'Foundation of Computer Studies': ['Evolution of Computers', 'Computer Organisation', 'Input Output Devices', 'Computer Storage', 'CPU', 'Operating System', 'Computer Setup'],
  'Computer Networking': ['Data Communication', 'Transmission Media', 'Network Elements', 'Network Topologies'],
  'Software Development': ['Programming Concepts'],
...
export const SUBSTRANDS = {
  ...
  // Biology (KICD Official Grade 10)
  'Cell Biology and Biodiversity': ['Introduction to Biology', 'Specimen Collection and Preservation', 'Cell Structure and Specialisation', 'Chemicals of Life'],
  'Anatomy and Physiology of Plants': ['Nutrition', 'Transport', 'Gaseous Exchange and Respiration'],
  'Anatomy and Physiology of Animals': ['Nutrition', 'Transport', 'Gaseous Exchange and Respiration'],
  // Biology Grade 11 & 12
  ...
  // Agriculture (KICD Official Grade 10)
  'Crop Production': ['Agricultural Land', 'Properties of Soil', 'Land Preparation', 'Field Management Practices', 'Growing Selected Crops', 'Weed Control', 'Crop Harvesting'],
  'Animal Production': ['Breeds of Livestock', 'Safe Handling of Animals', 'General Animal Health', 'Beekeeping', 'Animal Rearing Project'],
  'Agricultural Technologies and Entrepreneurship': ['Establishing Agricultural Enterprise', 'Marketing Agricultural Produce', 'Composting Techniques'],
  // Agriculture Grade 11 & 12
  ...
  // Arabic (KICD Official Grade 10)
  'Listening and Speaking': ['Listening Comprehension', 'Oral Presentation', 'Speaking Fluency', 'Attentive Listening', 'Selective Listening', 'Listening for Gist'],
  'Reading': ['Reading for Comprehension', 'Reading Fluency', 'Reading for Information', 'Poetry', 'Extensive Reading', 'Prose'],
  'Writing': ['Handwriting', 'Spelling', 'Paragraph Writing', 'Descriptive Writing', 'Creative Writing', 'Functional Writing'],
  'Grammar': ['Nouns', 'Pronouns and Conjunctions', 'Demonstratives and Articles', 'Adverbs and Prepositions', 'Verbs and Tenses', 'Sentence Patterns'],
