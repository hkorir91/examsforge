  ...
  return (
    <div className="flex h-[calc(100vh-56px)] overflow-hidden">
      ...
      <div className="flex-1 h-full overflow-hidden">
        {loading ? (
          <div className="h-full flex flex-col items-center justify-center gap-5 bg-gray-50">
          ...
          <div className="h-full flex flex-col items-center justify-center gap-6 bg-gray-50 p-8">
            <div className="w-20 h-20 bg-white rounded-2xl shadow-sm border border-gray-100 flex items-center justify-center">
              <svg width="40" height="40" fill="none" stroke="#003399" strokeWidth="1.5" viewBox="0 0 24 24">
            ...
            <div className="text-center max-w-sm">
              <h3 className="font-serif text-2xl text-gray-900 mb-2">Ready to generate your exam</h3>
